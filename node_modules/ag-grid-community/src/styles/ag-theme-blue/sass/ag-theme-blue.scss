...
// LEGACY THEME FILE
// Including this file emits CSS for the Blue theme. We no longer officially support this theme.
// See https://www.ag-grid.com/javascript-grid-themes-v23-migration/

@import "./legacy/ag-theme-blue-define-legacy-vars";

@include ag-theme-classic-impl("ag-theme-blue", (
