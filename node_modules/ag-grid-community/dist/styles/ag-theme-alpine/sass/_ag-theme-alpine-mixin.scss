...
@mixin ag-theme-alpine($params: ()) {
    ...
    .ag-tab-selected {
        color: ag-param(alpine-active-color);
    }
    ...
    .ag-set-filter-select-all {
        // default size is ag-param(list-item-height), make it a little larger
        height: ag-param(list-item-height) + ag-param(grid-size) * 2;
    }
    ...
    .ag-charts-format-sub-level-group {
        border-left: dashed 1px ag-param(border-color);
        padding-left: ag-param(grid-size);
    ...
    .ag-standard-button {
        ...
        border-radius: ag-param(border-radius);
        border: 1px solid ag-param(alpine-active-color);
        color: ag-param(alpine-active-color);
        ...
        &:hover {
            border-color: ag-param(alpine-active-color);
            background-color: rgba(ag-param(alpine-active-color), 0.1);
        }
    
        &:active {
            border-color: ag-param(alpine-active-color);
            background-color: ag-param(alpine-active-color);
    ...
    .ag-column-drop-vertical-empty-message {
        display: flex;
        align-items: center;
        border: dashed 1px ag-param(border-color);
        margin: ag-param(grid-size) * 2;
        padding: ag-param(grid-size) * 2;
    }

    .ag-column-drop-empty-message {
        color: rgba(ag-param(foreground-color), 0.75);
    }
